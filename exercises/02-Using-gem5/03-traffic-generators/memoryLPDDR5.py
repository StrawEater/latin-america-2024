...
parser.add_argument("genType", type=str, help="El tipo de Generador. r: random, l:linear")

args = parser.parse_args()

if args.genType == "r":
    generator = RandomGenerator(rate=args.rate, rd_perc=args.readRatio, num_cores=1)
elif args.genType == "l":
